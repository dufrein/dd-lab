...
var _usersFill = __webpack_require__(8);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(function () {

    (0, _jquery2.default)(document).ready(load());
    var rightSideP = document.getElementById("right-side-p");
    var rightSideImg = document.getElementById("right-side-img");
    var filds = { name: '', phone: '', email: '' };

    function load() {

        (0, _usersFill.fillUsers)();
        search.addEventListener('input', function () {
            var subStr = search.value;
            var pos = subStr.indexOf(':');
            var fild = subStr.substr(0, pos);
            var fildValue = void 0;
            if (subStr == "") {
                (0, _usersFill.fillUsers)();
                ...
                (0, _usersFill.fillUsersFilter)(fild, fildValue);
            } else {
                (0, _usersFill.fillUsersFilter)(fild = 'name', subStr);
            }
        });
    }
})();
...
exports.fillUsersFilter = exports.fillUsers = undefined;

var _userCard = __webpack_require__(9);

var fillUsers = exports.fillUsers = function fillUsers() {
    users.innerHTML = '';
    ...
    setTimeout(_userCard.readyFN, 500);
};

var fillUsersFilter = exports.fillUsersFilter = function fillUsersFilter(fild, subStr) {
    users.innerHTML = '';
    jQuery.getJSON("http://127.0.0.1:8080/users.json", function (data) {
...
var readyFN = exports.readyFN = function readyFN() {
    var list = document.querySelectorAll('#users li');
    list.forEach(function (item, i, arr) {
        var rightSideP = document.getElementById("right-side-p");
        var rightSideImg = document.getElementById("right-side-img");
        var index = item.id.substr(2);
